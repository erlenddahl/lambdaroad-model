...
namespace LambdaModel.Tests.FullRun.RoadNetwork
{
    ...
    public class FindLinksTests
    {
        ...
        {
            var bs = new RoadLinkBaseStation(0, 0, 100, 100);
        ...
        public void OneHere()
        {
            var bs = new RoadLinkBaseStation(275007.95, 7042725.97, 100, 50);
            ShapeLink.ReadLinks(@"..\..\..\..\Data\RoadNetwork\2021-05-28_smaller.shp", new[] { bs });
        ...
        {
            var bs = new RoadLinkBaseStation(288608.1, 7033525.3, 100, 1000);
            ShapeLink.ReadLinks(@"..\..\..\..\Data\RoadNetwork\2021-05-28_smaller.shp", new[] { bs });
        ...
        {
            var bs = new RoadLinkBaseStation(271868.3, 7041337.0, 100, 5_000);
            ShapeLink.ReadLinks(@"..\..\..\..\Data\RoadNetwork\2021-05-28_smaller.shp", new[] { bs });
